...
//                File file = new File("C:\\Users\\xpemz\\OneDrive\\Documents\\London_Postcode_Test_Files\\1000_London_Postcodes.txt");
                File file = new File("C:\\Users\\META\\Desktop\\materials\\data structures and algorithms\\London_Postcode_Test_Files\\1000_London_Postcodes.txt");
...
//        BinaryTree Tree = new BinaryTree();
        ...
        switch (input) {
            case 1: //count
                System.out.println("The number of postcodes in the BST are :" + Tree.count());
                break;
            case 2:     //insert
                    System.out.println("Please enter the postcode you would like to insert: ");
                    s.nextLine();
                    ...
                    System.out.println("The new BST is in this order:");
                    Tree.inOrder();
...
//                System.out.print(Tree.toString());
            ...
            case 3:     //delete
                s.nextLine();
                System.out.println("Please enter the postcode you would like to delete: ");
                String deleteCode = s.nextLine();
